 ...
 * 它是腾讯云用于区分客户的唯一标识。
 */
static const int SDKAPPID = TRTCSDK_APP_ID;
 ...
 * 文档：https://cloud.tenccreateMeetingent.com/document/product/269/32688#Server
 */
static NSString * const SECRETKEY = TRTCSDK_SECRET_KEY;
