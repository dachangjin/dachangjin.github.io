...
#ifndef ADNETWORK_CONFIG_ITEMS
#define ADNETWORK_CONFIG_ITEMS
...
NSArray *defaultConfigItems() {
    return @[
             ...
             @{
                 @"cgi_name": @"check_token",
                 @"request_path": @"/sns/auth?",
                 @"http_method": @"GET",
                 @"encrypt_algorithm": @"5",
                 @"decrypt_algorithm": @"6",
                 @"encrypt_key_path": @"kEncryptWholePacketParaKey",
             ...
             @{
                 @"cgi_name": @"refresh_token",
                 @"request_path": @"/sns/oauth2/refresh_token?",
                 @"http_method": @"GET",
                 @"encrypt_algorithm": @"5",
                 @"decrypt_algorithm": @"6",
                 @"encrypt_key_path": @"kEncryptWholePacketParaKey",
