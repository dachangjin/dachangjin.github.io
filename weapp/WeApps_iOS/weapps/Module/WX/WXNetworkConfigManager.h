...
AUTH_DEMO_EXTERN const NSString *kAccessTokenName;
AUTH_DEMO_EXTERN const NSString *kCheckTokenName;
AUTH_DEMO_EXTERN const NSString *kRefreshTokenName;
AUTH_DEMO_EXTERN const NSString *kUserinfoName;




@interface WXNetworkConfigManager : NSObject
